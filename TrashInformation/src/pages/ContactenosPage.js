...
function ContactenosPage(props) {
  ...
  return (
    <div className="contactenosPage-form">
      <Formik
        initialValues={{
          nombre: "",
          telefono: "",
        ...
        validate={(valores) => {
          ...
          if (!valores.telefono) {
            ...
            errores.telefono =
              "El teléfono solo puede contener números, mínimo 7 dígitos y máximo 10 dígitos.";
          }
          ...
          if (!valores.comentario) {
            errores.comentario =
              "Por favor ingresa un comentario antes de enviar";
          }
      ...
      >
        {({ errors }) => (
          <main>
            ...
            <p>
              Sus ideas y opiniones son importantes para nosotros. Gracias a sus
              comentarios, podemos identificar las áreas en que debemos mejorar.
              Puede realizar comentarios y sugerencias del servicio de
              recolección de basura en su barrio o puede comentarnos en que
              puede mejorar nuestra página web.
            </p>
            <Form className="formulario">
              ...
              <div>
                ...
                <ErrorMessage
                  name="tema"
                  component={() => <div className="error">{errors.tema}</div>}
                />
              </div>
              ...
              <div>
                ...
                <Field name="comentario" as="textarea" id="comentario" />
                <ErrorMessage
                  name="comentario"
                  component={() => (
